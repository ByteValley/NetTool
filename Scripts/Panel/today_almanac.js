...
;(async () => {
    ...
    try {
        ...
        log("script start, today =", todayStr, "raw $argument =", typeof $argument === "string" ? $argument : "");
        ...
        async function fetchJson(url, fallback) {
            ...
            const raw = await httpGet(url, 3000);
