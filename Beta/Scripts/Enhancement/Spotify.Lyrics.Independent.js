/* Spotify multi-source lyrics. Adapted from ByteValley/NetTool; matching, request handling, metadata triggering and caching modified. OpenCC character data: Apache-2.0, see spotify-lyrics-multisource/OpenCC-LICENSE. */
...
function makeLyrics(selected,request,format){
 ...
 const alternatives=[];
 // 所有平台统一使用 Spotify 原生 alternatives 承载双语/发音。
 // 主时间轴只保留原文，避免 Mac/iPhone/iPad 同时渲染合成行和 alternatives 导致重复。
