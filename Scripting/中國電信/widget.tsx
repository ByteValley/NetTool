...
const cardThemes = {
  fee: {
    tint: { light: "#4c9cff", dark: "#66adff" } as DynamicShapeStyle,
    icon: "bolt.horizontal.circle.fill",
  },
  voice: {
    tint: { light: "#50c88c", dark: "#63d8a0" } as DynamicShapeStyle,
    icon: "phone.fill",
  },
  flow: {
    tint: { light: "#ff9b5a", dark: "#ffb07a" } as DynamicShapeStyle,
    icon: "antenna.radiowaves.left.and.right",
  },
  otherFlow: {
    tint: { light: "#b478ff", dark: "#c59bff" } as DynamicShapeStyle,
