...
function titleRandom(daysToNext, nextName) {
  const dic = {
    ...
    31: titleLunar, // 农历信息
    32: titleSolar, // 阳历信息
    33: nextName ? `下一个：${nextName}` : "距离放假，还要摸鱼多少天？🥱"
  };
...
const bless = {
  ...
  "元宵节":"花灯高照月正圆，团团圆圆共此时。",
  "清明节":"风细雨潇潇，慎终追远寄哀思。", // 虽不在节日行显示，但保留文案
...
/* 标题随机：跟随“节日的最近项” */
$done({
  title: titleRandom(dF0, F3[0][0]),
  icon: iconNow(dF0),
  "icon-color": iconColor(dF0),
  content: `${lineTerm}\n\n${lineFest}`
});
})();
