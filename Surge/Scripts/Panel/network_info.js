// 功能：直连/入口/落地 IP 与位置；直连位置可按开关脱敏（仅旗帜 / 完整）；入口¹/²与运营商¹/²完整显示；中国境内 ISP 规范为“中国移动/联通/电信/广电”
// 图标：脚本接管（支持 $argument 传入 icon / icon-color）
// 台湾旗：TW_FLAG_MODE=0|1|2（0=用🇨🇳，1=用🇹🇼〔默认〕，2=备用🇼🇸）
...
const MASK_POS         = (Object.prototype.hasOwnProperty.call(ARG,'MASK_POS')
                          ? getArg('MASK_POS','1')==='1'
                          : MASK_IP)
const TW_FLAG_MODE     = String(getArg('TW_FLAG_MODE','1'))     // 0=🇨🇳  1=🇹🇼(默认)  2=🇼🇸
